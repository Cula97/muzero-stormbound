...
import gym
import numpy as np
from stormbot.gym_environments import storm_env_v2
import torch
...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (14, 5, 3)  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
        self.action_space = list(range(5*3*4 +1))  # Fixed list of all possible actions. You should only edit the length
...
class Game(AbstractGame):
    ...
    def step(self, action):
        ...
        return self._transpose(observation), reward, done
    ...
    def action_to_string(self, action_number):
        ...
        if action_number == 0:
            ...
            idx, row, col = storm_env_v2.decode_unit_action(action_number)
